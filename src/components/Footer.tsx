        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6 animate-slide-up">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Since 2017, we've been providing expert mobile repair services with 
              fast turnaround times and quality guarantees. Your device, our expertise.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  <div className="font-medium text-foreground">Shop 409-410</div>
                  <div className="text-muted-foreground">
                    Baitul View Tower<br />
