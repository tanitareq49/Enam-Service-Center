        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-foreground">A Brief History</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Established in 2017, Enam Service Center is your trusted mobile repair shop. 
                  We have five highly qualified hardware engineers and one software engineer. 
                  Additionally, we offer the latest accessories such as headsets, Bluetooth headphones, 
                  screen protectors, and phone covers.
                </p>
              </div>
              
              <div>
                <h4 className="text-lg font-semibold mb-3 text-foreground">Our Commitment</h4>
                <p className="text-muted-foreground leading-relaxed">
                  We are well known for our fast service and excellent communication. 
                  We always consider customer costs and consistently maintain our quality standards.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-primary/10 border border-primary/20 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground">Shop 409-410, Baitul View Tower</div>
                    <div className="text-sm text-muted-foreground">Purana Polton, Dhaka-1000</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                  <div className="font-medium text-foreground">+8801873065677</div>
                </div>
              </div>
              <Button 
                variant="whatsapp" 
          ...
          <div className="relative animate-scale-in">
            ...
            <div className="absolute top-1/4 -left-6 bg-accent text-accent-foreground p-3 rounded-xl shadow-soft animate-float-gentle" style={{ animationDelay: '1s' }}>
              <div className="text-center">
