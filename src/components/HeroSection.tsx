        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            <div className="space-y-4">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                From repairs to accessories, we provide expert solutions for your devices. 
                Enjoy fast, reliable, and affordable service to keep you connected.
              </p>
            </div>
          ...
          <div className="relative animate-scale-in">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-success text-success-foreground p-4 rounded-xl shadow-soft animate-float-gentle" style={{ animationDelay: '1s' }}>
                <div className="text-2xl font-bold">5K+</div>
                <div className="text-sm">Repairs</div>
              </div>
              
              <div className="absolute top-1/2 -right-6 bg-accent text-accent-foreground p-3 rounded-full shadow-soft animate-float-gentle" style={{ animationDelay: '2s' }}>
